              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <?php foreach ($this->cart->contents() as $cart) {
                    ...
                    ?>
                    <tr>
                      <input type="hidden" value="<?php echo $cart['rowid']; ?>" class="cartid" name="cartname">
                      <td class="text-center"><a href="#"><img src="<?php echo base_url('upload/' . $pic[0]); ?>" alt="iPod Classic" title="iPod Classic"></a></td>
                      <td class="text-left"><a href="product.html"><?php echo $cart['name']; ?></a></td>
                      <td class="text-left">product 11</td>
                      <td class="text-left">
                        <div style="max-width: 200px;" class="input-group btn-block">
                          <input type="number" class="form-control quantity" value="<?php echo $cart['qty']; ?>" name="quantity">
                          <span class="input-group-btn">
                            ...
                            <button class="btn btn-danger delete" title="" data-toggle="tooltip" type="button" name="delete" id="delete" data-original-title="Remove"><i class="fa fa-times-circle"></i></button>
                          </span>
                        </div>
                      </td>
                      <td class="text-right"><?php echo $cart['price']; ?></td>
                      <td class="text-right">PKR254.00</td>
                    </tr>
                  <?php } ?>
              ...
              <table class="table table-bordered">
                <tbody>
                  <tr>
                    ...
                    <td class="text-right"><span id="total_item"><?php echo $this->cart->total_items(); ?></span></td>
                  </tr>
                  <tr>
                    <td class="text-right"><strong>Sub-Total:</strong></td>
                    <td class="text-right"><span id="total"><?php echo $this->cart->total(); ?></span></td>
                  </tr>
                  <tr>
                    <td class="text-right"><strong>Shipping Fee</strong></td>
                    <td class="text-right"><span id="shipping">100</span></td>
                  </tr>
                  <tr>
                    <td class="text-right"><strong>Copen</strong></td>
                    <td class="text-right"></td>
                  </tr>
                  <tr>
                    <td class="text-right"><strong>Gift</strong></td>
                    <td class="text-right">
                      <input type="hidden" value="" id="giftValue" name="giftvalue">
                      <span id="giftCard">0</span>
                    </td>
                  </tr>
                  <tr>
