                        ...
                        <table id="demo-dt-basic" class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="min-tablet">Discount</th>
                                    <th>Edit</th>
                                    <th>Delete</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                foreach ($orderdetail_list as $orderdetail) {
                                    ...
                                    ?>
                                    <tr>
                                        <td><input type="checkbox" class="delete_order" value="<?php echo $orderdetail['orderdetailid']; ?>" /></td>
                                        ...
                                        <td><?php echo $orderdetail['discount']; ?></td>
