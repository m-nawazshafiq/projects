                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    foreach ($Specification_list as $Specification) {
                                        ...
                                        if($status == 0){ $status="Inactive"; }else{ $status="Active";}
                                        ?>
                                        <tr>
                                            <td><?php echo $Specification->Name; ?></td>
                                            <td><?php echo $Specification->Description; ?></td>
                                            <td><?php echo $status; ?></td>
                                            <td><a href="<?php echo base_url() . 'Specification/edit/' . $Specification->Id; ?>" class="btn btn-warning">Edit</a></td>
                                            <td><a href="<?php echo base_url() . 'Specification/delete/' . $Specification->Id; ?>" class="btn btn-danger">Delete</a></td>
                                        </tr>
