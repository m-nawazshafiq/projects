                        ...
                        <div class="row">
                            <div class="content-header clearfix">
                                ...
                                <div class="pull-right">
                                    <a class="btn bg-blue" href="<?php echo base_url(); ?>page/savepage">
                                ...
                                <tbody>
                                    ...
                                    foreach ($pages_list as $page) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url() . 'page/edit/' . $page->id; ?>" class="btn btn-warning">Edit</a></td>
                                            <td><a href="<?php echo base_url() . 'page/delete/' . $page->id; ?>" class="btn btn-danger">Delete</a></td>
                                        </tr>
