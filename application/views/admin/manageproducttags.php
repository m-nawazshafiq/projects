                        ...
                        <div class="row">
                            <div class="content-header clearfix">
                                ...
                                <div class="pull-right">
                                    <a class="btn bg-blue" href="<?php echo base_url(); ?>Tags/SaveTags">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr role="row">                                        
                                        <th>Product Name</th>
                                        <th class="min-tablet">Tag Name</th>
                                        <th>Edit</th>
                                        <th>Delete</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    foreach ($producttags_list as $Tags) {
                                        $product=$this->Product_model->getProductById($Tags->ProductId);
                                        $tag=$this->Tags_model->getTagsById($Tags->TagId);
                                        ?>
                                        <tr>                                           
                                            <td><?php echo $product[0]['Name']; ?></td>
                                            <td><?php echo $tag[0]['Name']; ?></td>
                                            <td><a href="<?php echo base_url() . 'Tags/editproducttags/' . $Tags->Id; ?>" class="btn btn-warning">Edit</a></td>
                                            <td><a href="<?php echo base_url() . 'Tags/deleteproducttags/' . $Tags->Id; ?>" class="btn btn-danger">Delete</a></td>
                                        </tr>
