...
<body>
    ...
    <div id="container" class="effect mainnav-full">
        ...
        <!--===================================================-->
        <!--END NAVBAR-->
        <?php echo form_open_multipart('Blog/SaveBlog'); ?>
        <div class="boxed">
            <!--CONTENT CONTAINER-->
            <!--===================================================-->
                        ...
                        <div class="col-md-12">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control text-box single-line" id="blogName" name="blogName" type="text" value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                        <textarea id="descriptionblog" class="" name="descriptionblog"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                        <textarea id="titleBlog" class="" name="titleBlog"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                        <textarea id="quoteBlog" class="" name="quoteBlog"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-3">
