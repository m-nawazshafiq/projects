                ...
                <div class="row">
                    <div class="content-header clearfix">
                        ...
                        <div class="pull-right">
                            <a class="btn bg-blue" href="<?php echo base_url(); ?>Brand/Create">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            foreach ($brand_list as $brand) {
                                ...
                                <tr>
                                    <td>
                                        <div><img src="<?php echo base_url('upload/' . $brand->Picture); ?>" alt="No image"></div>
                                    </td>
                                    <td><?php echo $brand->Name; ?></td>
                                    <td><?php echo $brand->Code; ?></td>
                                    <td><a href="<?php echo base_url() . 'Brand/edit/' . $brand->Id; ?>" class="btn btn-warning">Edit</a></td>
                                    <td><a href="<?php echo base_url() . 'Brand/delete/' . $brand->Id; ?>" class="btn btn-danger">Delete</a></td>
                                </tr>
