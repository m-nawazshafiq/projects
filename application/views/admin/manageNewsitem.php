                        ...
                        <div class="row">
                            <div class="content-header clearfix">
                                ...
                                <div class="pull-right">
                                    <a class="btn bg-blue" href="<?php echo base_url(); ?>Newsitem/SaveNewsitem">
                                ...
                                <tbody>
                                    ...
                                    foreach ($News_list as $News) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url() . 'Newsitem/edit/' . $News->id; ?>" class="btn btn-warning">Edit</a></td>
                                            <td><a href="<?php echo base_url() . 'Newsitem/delete/' . $News->id; ?>" class="btn btn-danger">Delete</a></td>
                                        </tr>
