                        ...
                        <div class=" col-md-12 col-xs-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-3">
                                            <div class="label-wrapper"><label class="control-label" for="SearchIncludeSubCategories">RValue</label>
                                                <div title="Check to search in subcategories." data-toggle="tooltip" class="ico-help"><i class="fa fa-question-circle"></i></div>
                                            </div>
                                        </div>
                                        <div class="col-md-9">
                        ...
                        <div class=" col-md-12 col-xs-12">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class=" col-md-10 add-categories-button ">
                                    <input class="" type="file" name="uploadPicture[]" multiple />
                                </div>
                                        ...
                                        <?php foreach ($attributes_list as $attributes) { ?>
                                            <div class="form-horizontal">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input class="check-box" data-val="true" data-val-required="The Search subcategories field is required." value="1" id="<?php echo $attributes->Name  ?>" name="attributes[<?php echo $attributes->Id;  ?>]" type="<?php echo $attributes->inputType; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        <?php  } ?>
