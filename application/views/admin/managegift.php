                ...
                <div class="row">
                    <div class="content-header clearfix">
                        ...
                        <div class="pull-right">
                            <a class="btn bg-blue" href="<?php echo base_url(); ?>Gift/Create">
                        ...
                        <table id="demo-dt-basic" class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>Type</th>
                                    <th>Initial</th>
                                    <th class="min-tablet">CuponCode</th>
                                    <th class="min-tablet">Recipient Name</th>
                                    <th class="min-desktop">Send Name</th>
                                    <th class="min-desktop">Message</th>
                                    <th class="min-desktop">Created Date</th>
                                    <th class="min-desktop">Activated</th>
                                    <th>Edit</th>
                                    <th>Delete</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                foreach ($gift_list as $gift) {
                                    ...
                                    ?>
                                    <tr>
                                        <td><input type="checkbox" class="delete_checkbox" value="<?php echo $gift->Id ?>" /></td>

                                        <td><?php echo $gift->Type; ?></td>
                                        <td><?php echo $gift->InitialValue; ?></td>
                                        <td><?php echo $gift->CuponCode; ?></td>
                                        <td><?php echo $gift->RecName; ?></td>
                                        <td><?php echo $gift->SendName; ?></td>
                                        <td><?php echo $gift->Message; ?></td>
                                        <td><?php echo $gift->CreatedDate; ?></td>
                                        <td><?php echo $gift->Activated; ?></td>
                                        <td><a href="<?php echo base_url() . 'Gift/edit/' . $gift->Id; ?>" class="btn btn-warning">Edit</a></td>
                                        <td><a href="<?php echo base_url() . 'Gift/delete/' . $gift->Id; ?>" class="btn btn-danger">Delete</a></td>
                                    </tr>
