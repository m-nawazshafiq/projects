                        ...
                        <div class="row">
                            <div class="content-header clearfix">
                                ...
                                <div class="pull-right">
                                    <a class="btn bg-blue" href="<?php echo base_url(); ?>blog/saveblog">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    foreach ($blog_list as $blog) {
                                        ...
                                        <tr>
                                            <td>
                                                <div><img style="width:200px" src="<?php echo base_url('upload/' . $pic[0]); ?>" alt="No image"></div>
                                            </td>
                                            <td><?php echo $blog->name; ?></td>
                                            <td><?php echo $blog->description; ?></td>
                                            <td><?php echo $blog->status; ?></td>
                                            <td><?php echo $blog->createdBy; ?></td>
                                            <td><?php echo $blog->createdDate; ?></td>

                                            <td><a href="<?php echo base_url() . 'blog/edit/' . $blog->id; ?>" class="btn btn-warning">Edit</a></td>
                                            <td><a href="<?php echo base_url() . 'blog/delete/' . $blog->id; ?>" class="btn btn-danger">Delete</a></td>
                                        </tr>
