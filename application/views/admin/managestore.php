                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr role="row">
                                        <th>Store Name</th>
                                        <th>URL</th>
                                        <th class="min-tablet">Display Order</th>
                                        <th>Edit</th>
                                        <th>Delete</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    foreach ($store_list as $store) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $store->DisplayOrder; ?></td>
                                            <td><a href="<?php echo base_url() . 'store/editStore/' . $store->id; ?>" class="btn btn-warning">Edit</a></td>
                                            <td><a href="<?php echo base_url() . 'store/delete/' . $store->id; ?>" class="btn btn-danger">Delete</a></td>
                                        </tr>
