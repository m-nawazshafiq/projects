...
<body>
    ...
    <div id="container" class="effect mainnav-full">
        ...
        <!--===================================================-->
        <!--END NAVBAR-->
        <?php echo form_open_multipart('Attributes/edit/' . $attributes['Id']); ?>
        <div class="boxed">
            <!--CONTENT CONTAINER-->
            <!--===================================================-->
            ...
            <div class="content-header clearfix">
                <h1 class="pull-left">
                    ...
                    <small>
                        ...
                        <a href="<?php base_url(); ?>/Attributes">Back to Attributes List</a>
                    </small>
                </h1>
                        ...
                        <div class=" col-md-12 col-xs-12">
                            ...
                            <div class="Product-info-title">
                                <div class="product-info-icon">
                                    <i class="fa fa-info "></i> <span class="product-info-text">Attributes</span>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-3">
                                            <div class="label-wrapper"><label class="control-label" for="SearchIncludeSubCategories">Attribute Name</label>
                                                <div title="Check to search in subcategories." data-toggle="tooltip" class="ico-help"><i class="fa fa-question-circle"></i></div>
                                            </div>
                                        </div>
                                        <div class="col-md-9">
                                            <input class="form-control text-box single-line" id="attributeName" name="attributeName" type="text" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-3">
                                            <div class="label-wrapper"><label class="control-label" for="SearchIncludeSubCategories">Attributes Description</label>
                                                <div title="Check to search in subcategories." data-toggle="tooltip" class="ico-help"><i class="fa fa-question-circle"></i></div>
                                            </div>
                                        </div>
                                        <div class="col-md-9">
                                            <textarea id="descriptionAttributes" class="" name="descriptionAttributes"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-3">
                                            <div class="label-wrapper"><label class="control-label" for="SearchIncludeSubCategories">Status</label>
                                                <div title="Check to search in subcategories." data-toggle="tooltip" class="ico-help"><i class="fa fa-question-circle"></i></div>
                                            </div>
                                        </div>
                                        <div class="col-md-9">
                                            <input class="form-control text-box single-line" id="attributeStatus" name="attributeStatus" type="text" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-3">
                                            <div class="label-wrapper"><label class="control-label" for="SearchIncludeSubCategories">Type of Input</label>
                                                <div title="Check to search in subcategories." data-toggle="tooltip" class="ico-help"><i class="fa fa-question-circle"></i></div>
                                            </div>
                                        </div>
                                        <div class="col-md-9">
                                            <select class="form-control valid" data-val="true" data-val-required="The Parent category field is required." id="inputType" name="inputType">
