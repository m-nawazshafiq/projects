                ...
                <div class="row">
                    <div class="content-header clearfix">
                        ...
                        <div class="pull-right">
                            <a class="btn bg-blue" href="<?php echo base_url(); ?>Customer/SaveCustomer">
                            ...
                            <tbody>
                                ...
                                foreach ($customer_list as $customer) {
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url() . 'customer/edit/' . $customer->Id; ?>" class="btn btn-warning">Edit</a></td>
                                        <td><a href="<?php echo base_url() . 'customer/delete/' . $customer->Id; ?>" class="btn btn-danger">Delete</a></td>
                                    </tr>
