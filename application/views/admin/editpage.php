...
<body>
    ...
    <div id="container" class="effect mainnav-full">
        ...
        <!--===================================================-->
        <!--END NAVBAR-->
        <?php echo form_open_multipart('Page/edit/' . $page['id']); ?>
        <div class="boxed">
            <!--CONTENT CONTAINER-->
            <!--===================================================-->
                        ...
                        <div class="col-md-12">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-md-3">
                                        <div class="label-wrapper"><label class="control-label" for="SearchIncludeSubCategories">Page Title</label>
                                ...
                                <div class="form-group">
                                    <div class="col-md-3">
                                        <div class="label-wrapper"><label class="control-label" for="SearchIncludeSubCategories">Page Body</label>
                                            <div title="Check to search in subcategories." data-toggle="tooltip" class="ico-help"><i class="fa fa-question-circle"></i></div>
                                        </div>
                                    </div>
                                    <div class="col-md-9">
                                        <textarea id=" froala-editor"" class="" name=" pagebody" rows="10"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-3">
