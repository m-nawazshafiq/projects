                                ...
                                <tbody>
                                    ...
                                    foreach ($Tags_list as $Tags) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $tag ?></td>
                                            <td><a href="<?php echo base_url() . 'Tags/edit/' . $Tags->Id; ?>" class="btn btn-warning">Edit</a></td>
                                            <td><a href="<?php echo base_url() . 'Tags/delete/' . $Tags->Id; ?>" class="btn btn-danger">Delete</a></td>
                                        </tr>
