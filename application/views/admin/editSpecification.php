...
<body>
    ...
    <div id="container" class="effect mainnav-full">
        ...
        <!--===================================================-->
        <!--END NAVBAR-->
        <?php echo form_open_multipart('Specification/edit/' . $Specification['Id']); ?>
        <div class="boxed">
            <!--CONTENT CONTAINER-->
            <!--===================================================-->
                        ...
                        <div class=" col-md-12 col-xs-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-3">
                                            <div class="label-wrapper"><label class="control-label" for="SearchIncludeSubCategories">Specification Description</label>
                                                <div title="Check to search in subcategories." data-toggle="tooltip" class="ico-help"><i class="fa fa-question-circle"></i></div>
                                            </div>
                                        </div>
                                        <div class="col-md-9">
                                            <textarea id="descriptionSpecification" class="" name="descriptionSpecification"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control text-box single-line" id="Specificationtatus" name="Specificationtatus" type="text" value="">
                                        </div>
                                    </div>
