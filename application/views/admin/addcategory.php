...
<body>
    <div id="container" class="effect mainnav-full">
        ...
        <!--===================================================-->
        <!--END NAVBAR-->
        <form method="POST" action="<?php echo base_url(); ?>Category/SaveCategory" enctype="multipart/form-data">
            <div class="boxed">
                <!--CONTENT CONTAINER-->
                <!--===================================================-->
                                ...
                                <div class="col-md-12">
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control text-box single-line" id="txtCategoryName" name="txtCategoryName" type="text" value="">
                                            </div>
                                        </div>
                                        <div class="from-horizontal">
                                            <div class="form-horizontal">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input class="form-control text-box single-line" id="txtCategoryCode" name="txtCategoryCode" type="text" value="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                                ...
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-lg-12 nopadding">
                                                                            <textarea id="descriptionCategory" class="" name="descriptionCategory"></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class=" col-md-10 add-categories-button ">
                                                            <input class="" type="file" name="uploadPicture">
                                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input class="check-box" data-val="true" data-val-required="The Search subcategories field is required." id="publishCategory" name="publishCategory" type="checkbox">
                                                    </div>
                                                </div>
                                                <!-- .....Show on home page.... -->
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input class="check-box" data-val="true" data-val-required="The Search subcategories field is required." id="showOnHomeCategory" name="showOnHomeCategory" type="checkbox">
                                                    </div>
                                                </div>
                                                <!-- ...............Include in top menu................. -->
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input class="form-control text-box single-line" id="priceRangeCategory" name="priceRangeCategory" type="text" value="">
                                                    </div>
                                                </div>
                                                <!-- Display order -->
                                                <div class="form-group">
