...
$(document).on('ready', function () {
    ...
    function myfunc(input, previewDiv) {
        if (input.files) {
            ...
            for (i = 0; i < filesAmount; i++) {
                ...
                reader.onload = function (event) {
                    $($.parseHTML('<img>')).attr('src', event.target.result).appendTo(previewDiv);
                }
    ...
    $('#upload-img').on('change', function () {
        //$(".img-preview").remove();
        myfunc(this, 'div.img-preview');
    });

    // =================================================================
    // Dynamically add dropdown with input field and delete btn
    // =================================================================

    $("#addRowBtn").click(function () {

        var $div = $('div[id^="cloneDiv"]:last');

        var num = parseInt($div.prop("id").match(/\d+/g), 10);

        var id = "cloneDiv" + num;
        var delBtnId = num + "cloneDeleteBtn";
        var txtId = num + "cloneTxt";
        num++;
        var clonedSection = $("#" + id).clone().attr('id', "cloneDiv" + num).addClass('cloneRows');

        clonedSection.find("#cloneTxtWrapper").find("#" + txtId).val("");

        clonedSection.find("#cloneTxtWrapper").find("#" + txtId).attr("id", num + "cloneTxt");

        clonedSection.find("#" + delBtnId).attr("id", num + "cloneDeleteBtn");

        clonedSection.appendTo("#addRows");

    });


    $("#addRows").on("click", 'button', function () {

        var clonesLength = $('#addRows').children().length;
        var btnId = event.target.id;
        var num = parseInt(btnId, 10);
    ...
    // =================================================================
    // Dynamically add dropdown with checkbox and delete btn
    // =================================================================

    $("#addCheckBoxRowBtn").click(function () {

        var $div = $('div[id^="cloneCheckBoxDiv"]:last');

        var num = parseInt($div.prop("id").match(/\d+/g), 10);

        var id = "cloneCheckBoxDiv" + num;
        var delBtnId = num + "deleteCheckBoxCloneBtn";
        var txtId = num + "cloneCheckBox";
        num++;
        var clonedSection = $("#" + id).clone().attr('id', "cloneCheckBoxDiv" + num).addClass('cloneRows');

        clonedSection.find("#cloneCheckboxWrapper").find("#" + txtId).prop('checked', false);

        clonedSection.find("#cloneCheckboxWrapper").find("#" + txtId).attr("id", num + "cloneCheckBox");

        clonedSection.find("#" + delBtnId).attr("id", num + "deleteCheckBoxCloneBtn");

        clonedSection.appendTo("#addCheckBoxRows");

    });


    $("#addCheckBoxRows").on("click", 'button', function () {

        var clonesLength = $('#addCheckBoxRows').children().length;
        var btnId = event.target.id;
        var num = parseInt(btnId, 10);

        if (clonesLength > 1) {
            $("#cloneCheckBoxDiv" + num).remove();
        } else {
            $("#" + num + "cloneCheckBox").prop('checked', false);
        }
    });
    ...
    //script for spinner type input number
